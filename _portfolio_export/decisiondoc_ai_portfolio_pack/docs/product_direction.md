...
- DocumentOps browser controls that create governance records or start a provider-backed Agent request are single-flight while pending. This reduces same-control duplicate clicks without claiming backend idempotency or cross-client serialization.
