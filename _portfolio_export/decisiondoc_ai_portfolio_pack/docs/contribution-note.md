...
| 검증 | 현재 증거 |
|---|---|
| Non-live pytest gate | `pytest tests/ -m "not live" -q` -> `3507 passed, 1 skipped, 4 deselected` (2026-07-16 실측) |
| GitHub Actions CI | 최근 확인한 main 자동화 증적: commit `c214383`, CI `29491858979` success (`3471 passed, 5 skipped`) |
| GitHub Actions CD | 최근 확인한 main 자동화 증적: commit `c214383`, CD `29491859049` success. image digest는 `sha256:ce2a3979001234bb9ca40f64e8cf9b9b9ecf9ae3054137c28dae8925d527c254`이며 staging deploy/smoke와 production deploy는 skip되어 M6 proof로 보지 않는다 |
