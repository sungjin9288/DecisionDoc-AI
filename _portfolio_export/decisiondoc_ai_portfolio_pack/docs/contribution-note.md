...
| 검증 | 현재 증거 |
|---|---|
| Non-live pytest gate | `pytest tests/ -m "not live" -q` -> `3434 passed, 2 skipped, 4 deselected` (2026-07-16 실측) |
| GitHub Actions CI | 최근 확인한 main 자동화 증적: commit `af5f4fd`, CI `29487218282` success (`3405 passed, 5 skipped`) |
| GitHub Actions CD | 최근 확인한 main 자동화 증적: commit `af5f4fd`, CD `29487218293` success. image digest는 `sha256:e28659bd7c549ae7cc0765b1597374f0ba8115204eb169968cdc8ba2648ee25a`이며 staging deploy/smoke와 production deploy는 skip되어 M6 proof로 보지 않는다 |
