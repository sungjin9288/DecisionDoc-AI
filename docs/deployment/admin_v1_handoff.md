...
| 운영/인수인계 담당자 | [Admin v1.1.58 Acceptance Record 2026-04-30](./admin_v1_1_58_acceptance_20260430.md) | 최신 production release, deploy, smoke, Report Workflow ERP smoke acceptance 증적 확인 |
...
3. 배포 후에는 반드시 아래 evidence를 남깁니다.
   ...
   - 최신 production acceptance record: [Admin v1.1.58 Acceptance Record 2026-04-30](./admin_v1_1_58_acceptance_20260430.md)
   - 회사 전달 pack baseline: [Admin v1 Acceptance Record 2026-04-23](./admin_v1_acceptance_20260423.md)
   - latest `main` CI green baseline 확인: `GitHub Actions CI run 25116943284 (success)`
