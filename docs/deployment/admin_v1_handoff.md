...
| 운영/인수인계 담당자 | [Admin v1.1.77 Acceptance Record 2026-05-14](./admin_v1_1_77_acceptance_20260514.md) | 최신 production release, runtime version display, deploy, smoke acceptance 증적 확인 |
| 운영/인수인계 담당자 | [Admin v1.1.65 Acceptance Record 2026-04-30](./admin_v1_1_65_acceptance_20260430.md) | 이전 production release, deploy, smoke, company handoff evidence release acceptance 증적 확인 |
...
| 운영/인수인계 담당자 | [Admin v1.1.59 Acceptance Record 2026-04-30](./admin_v1_1_59_acceptance_20260430.md) | 이전 production release handoff evidence acceptance 증적 확인 |
...
3. 배포 후에는 반드시 아래 evidence를 남깁니다.
   ...
   - 최신 production acceptance record: [Admin v1.1.77 Acceptance Record 2026-05-14](./admin_v1_1_77_acceptance_20260514.md)
   - 회사 전달 pack baseline: [Admin v1 Acceptance Record 2026-04-23](./admin_v1_acceptance_20260423.md)
   - latest `main` CI green baseline 확인: `GitHub Actions CI run 25835487045 (success)`
