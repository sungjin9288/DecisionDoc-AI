...
- 최근 확인한 main 자동화 증적: commit `26ec28b` 기준 GitHub Actions CI `29453083687` success, CD `29453083931` success. CD는 image build/push까지만 수행했고 staging deploy/smoke와 production deploy는 skip되어 M6 proof는 아니다.
...
# 2026-07-16 실측: 3135 passed, 2 skipped, 4 deselected
