...
결과: `4266 passed, 2 skipped, 4 deselected, 1 warning` (2026-07-21 H95 실측, 외부 provider·G2B·Stripe key를 process에서 제거하고 provider capability를 mock으로 고정).
