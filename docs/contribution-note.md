...
| 검증 | 현재 증거 |
|---|---|
| Non-live pytest gate | `pytest tests/ -m "not live" -q` -> `4007 passed, 2 skipped, 4 deselected` (2026-07-17 H58 실측) |
| GitHub Actions CI | 마지막으로 문서화한 main 자동화 증적: commit `e286f2f`, CI `29502322163` success (`3554 passed, 5 skipped`) |
| GitHub Actions CD | 마지막으로 문서화한 main 자동화 증적: commit `e286f2f`, CD `29502322086` success. image digest는 `sha256:c72c286bcaabea41d59081631e4cf5ef6a1496f2f0cafaf01a96114732e6a384`이며 staging deploy/smoke와 production deploy는 skip되어 M6 proof로 보지 않는다 |
