...
| DocumentOps 이력 | `tests/test_document_ops_agent_api.py`, `tests/storage/test_trajectory_store.py`, `tests/storage/test_trajectory_store_integrity.py`, `tests/test_audit.py`, `tests/test_infrastructure.py`, `tests/e2e/test_main_flow.py` | explicit tenant/backend contract, 손상·ownership drift·중복 ID 차단, process lock 없는 local/fake-S3 append/review CAS, bounded private receipt·lost-response reconciliation, tenant/filter/search total, 양방향 pagination, summary/lazy detail, 열람·review audit, desktop/mobile 작업대 |
