...
- `python3 scripts/deploy_compose_local.py --env-file .env.prod --image decisiondoc-<site>-local --post-check` — rollout 뒤 post-deploy check와 `./reports/post-deploy.json` 저장까지 수행
