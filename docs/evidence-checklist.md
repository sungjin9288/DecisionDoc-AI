...
| Non-live 전체 pytest gate | 완료 | 외부 provider·G2B·Stripe key를 process에서 제거하고 provider capability를 mock으로 고정한 `pytest tests/ -m "not live" -q` -> `4261 passed, 2 skipped, 4 deselected, 1 warning` (2026-07-21 H92 실측) |
| GitHub Actions CI | 완료 | 마지막으로 확인한 main 자동화 증적: commit `2f21755`, CI `29795185039` success (`4244 passed, 5 skipped`) |
| GitHub Actions CD | 완료 | 마지막으로 확인한 main 자동화 증적: commit `2f21755`, CD `29795185042` success. image digest `sha256:59dd8b988fad6e7d087a0c47b4f99c5c231dd48731a8ad22535a12ccdcb10743`; staging deploy/smoke와 production deploy는 skip되어 배포 proof에서 제외 |
