...
| Non-live 전체 pytest gate | 완료 | `pytest tests/ -m "not live" -q` -> `3470 passed, 2 skipped, 4 deselected` (2026-07-16 실측) |
| GitHub Actions CI | 완료 | 최근 확인한 main 자동화 증적: commit `2db483f`, CI `29489716059` success (`3435 passed, 5 skipped`) |
| GitHub Actions CD | 완료 | 최근 확인한 main 자동화 증적: commit `2db483f`, CD `29489716017` success. image digest `sha256:bc10f4d5eb1df62288420b264e09c3ff152a1faa5752170723b39e45d7305b47`; staging deploy/smoke와 production deploy는 skip되어 배포 proof에서 제외 |
