...
| G6 | **배포 접근성 미검증** — 최신 GitHub Actions CD는 성공했지만 staging deploy/smoke는 설정 부재로 skip되어 운영 URL 동작 보장 없음 (README §Scope 명시) | GitHub Actions CD `28961688221` success, staging deploy/smoke skipped | MED | 미착수 |
