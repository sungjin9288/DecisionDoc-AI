...
PROOF_PLAN_LINES = (
    ...
    "",
    "# M1 no-secret proof receipt after approved external proof",
    ...
    "",
    "# M2/M6 runner-owned receipts: preflight does not execute external proof",
    "python3 scripts/run_stage_procurement_smoke.py --env-file .env.prod --preflight --proof-receipt reports/completion-readiness/m2-g2b-stage-smoke-preflight.json",
    "python3 scripts/run_deployed_smoke.py --env-file .env.prod --preflight --proof-receipt reports/completion-readiness/m6-deployment-smoke-preflight.json",
    "",
    "# Run only after explicit external-proof approval; use separate paths to preserve preflight history",
    "python3 scripts/run_stage_procurement_smoke.py --env-file .env.prod --proof-receipt reports/completion-readiness/m2-g2b-stage-smoke-proof.json",
    "python3 scripts/run_deployed_smoke.py --env-file .env.prod --proof-receipt reports/completion-readiness/m6-deployment-smoke-proof.json",
    "",
    "# Validate the no-secret receipts",
    "python3 scripts/check_completion_proof_receipt.py reports/completion-readiness/m1-live-provider-proof.json",
    "python3 scripts/check_completion_proof_receipt.py reports/completion-readiness/m2-g2b-stage-smoke-preflight.json",
    "python3 scripts/check_completion_proof_receipt.py reports/completion-readiness/m2-g2b-stage-smoke-proof.json",
    "python3 scripts/check_completion_proof_receipt.py reports/completion-readiness/m6-deployment-smoke-preflight.json",
