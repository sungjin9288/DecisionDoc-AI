#!/usr/bin/env python3
"""Validate the DocumentOps Phase 354-358 validated handoff sign-off closure index."""
...
from scripts.create_documentops_phase355_validated_closure_receipt_summary_handoff_signoff_pending_signoff import (  # noqa: E402
    build_pending_documentops_phase355_validated_closure_receipt_summary_handoff_signoff,
)
from scripts.summarize_documentops_phase355_validated_closure_receipt_summary_handoff_signoffs import (  # noqa: E402
    build_documentops_phase355_validated_closure_receipt_summary_handoff_signoff_summary,
)
from scripts.validate_documentops_phase353_validated_closure_receipt_summary_handoff import (  # noqa: E402
    validate_documentops_phase353_validated_closure_receipt_summary_handoff,
)
from scripts.validate_documentops_phase354_validated_closure_receipt_summary_handoff_signoff import (  # noqa: E402
    validate_documentops_phase354_validated_closure_receipt_summary_handoff_signoff,
)
from scripts.validate_documentops_phase357_validated_closure_receipt_summary_handoff_signoff_summary import (  # noqa: E402
    validate_documentops_phase357_validated_closure_receipt_summary_handoff_signoff_summary,
)
...
EXPECTED_REPORT_TYPE = (
    "document_ops_phase359_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_index"
)
EXPECTED_VALIDATION_REPORT_TYPE = (
    "document_ops_phase359_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_index_validation"
)
EXPECTED_STATUS = (
    "validated_closure_receipt_summary_handoff_signoff_closure_index_ready_no_aws_no_training_authorization"
)
EXPECTED_SCOPE = (
    "local_read_only_phase354_to_phase358_validated_closure_receipt_summary_handoff_signoff_closure_validation"
)
EXPECTED_ARTIFACTS = {
    "phase354_validated_closure_receipt_summary_handoff": {
        "phase": 354,
        "path": "docs/specs/hermes_decisiondoc_agent/phase354_local_feature_completion_validated_closure_receipt_summary_handoff/validated_closure_receipt_summary_handoff.json",
        "validator": "scripts/validate_documentops_phase353_validated_closure_receipt_summary_handoff.py",
    },
    "phase355_validated_closure_receipt_summary_handoff_signoff_template": {
        "phase": 355,
        "path": "docs/specs/hermes_decisiondoc_agent/phase355_local_feature_completion_validated_closure_receipt_summary_handoff_signoff/validated_closure_receipt_summary_handoff_signoff_template.json",
        "validator": "scripts/validate_documentops_phase354_validated_closure_receipt_summary_handoff_signoff.py",
    },
    "phase356_pending_validated_closure_receipt_summary_handoff_signoff_generation_contract": {
        "phase": 356,
        "path": "docs/specs/hermes_decisiondoc_agent/phase356_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_pending_signoff/pending_validated_closure_receipt_summary_handoff_signoff_generation_contract.json",
        "validator": "scripts/create_documentops_phase355_validated_closure_receipt_summary_handoff_signoff_pending_signoff.py",
    },
    "phase357_validated_closure_receipt_summary_handoff_signoff_summary_contract": {
        "phase": 357,
        "path": "docs/specs/hermes_decisiondoc_agent/phase357_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_summary/validated_closure_receipt_summary_handoff_signoff_summary_contract.json",
        "validator": "scripts/summarize_documentops_phase355_validated_closure_receipt_summary_handoff_signoffs.py",
    },
    "phase358_validated_closure_receipt_summary_handoff_signoff_summary_validation_contract": {
        "phase": 358,
        "path": "docs/specs/hermes_decisiondoc_agent/phase358_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_summary_validation/validated_closure_receipt_summary_handoff_signoff_summary_validation_contract.json",
        "validator": "scripts/validate_documentops_phase357_validated_closure_receipt_summary_handoff_signoff_summary.py",
    },
}
...
PASS_MESSAGE = "PASS documentops phase359 validated closure receipt summary handoff sign-off closure index validated"
FAIL_MESSAGE = "FAIL documentops phase359 validated closure receipt summary handoff sign-off closure index validation failed"
...
def _run_closure_probe() -> dict[str, Any]:
    phase354_result = validate_documentops_phase353_validated_closure_receipt_summary_handoff(
        _repo_path(EXPECTED_ARTIFACTS["phase354_validated_closure_receipt_summary_handoff"]["path"])
    )
    template_path = _repo_path(
        EXPECTED_ARTIFACTS["phase355_validated_closure_receipt_summary_handoff_signoff_template"]["path"]
    )
    phase355_template_result = validate_documentops_phase354_validated_closure_receipt_summary_handoff_signoff(
        _load_json(template_path)
    )

    with tempfile.TemporaryDirectory(prefix="decisiondoc_phase359_closure_") as tmp_dir:
        tmp_path = Path(tmp_dir)
        pending_signoff = build_pending_documentops_phase355_validated_closure_receipt_summary_handoff_signoff(
            signoff_id=(
                "documentops_local_feature_completion_phase354_validated_closure_receipt_summary_handoff_"
                "signoff_phase359probe"
            ),
            created_at="2026-06-15T00:00:00+09:00",
        )
        pending_path = tmp_path / "phase359_pending_signoff.json"
        _write_json(pending_path, pending_signoff)
        phase356_pending_result = validate_documentops_phase354_validated_closure_receipt_summary_handoff_signoff(
            pending_signoff
        )

        summary = build_documentops_phase355_validated_closure_receipt_summary_handoff_signoff_summary(
            [pending_path],
            generated_at="2026-06-15T00:00:00+09:00",
        )
        summary_path = tmp_path / "phase359_pending_summary.json"
        _write_json(summary_path, summary)
        phase358_summary_result = validate_documentops_phase357_validated_closure_receipt_summary_handoff_signoff_summary(
            summary_path
        )

    return {
        "phase354_validated_closure_receipt_summary_handoff": phase354_result,
        "phase355_signoff_template": phase355_template_result,
        "phase356_temporary_pending_signoff": phase356_pending_result,
        "phase357_temporary_pending_summary": {
        ...
        "phase358_temporary_summary_validation": phase358_summary_result,
    }


def validate_documentops_phase354_to_phase358_validated_closure_receipt_summary_handoff_signoff_closure_index(
    ...
    if index.get("phase") != 359:
        errors.append("phase must be 359")
    ...
    for field in (
        ...
        "runs_phase354_validator",
        "validates_phase355_template",
        "generates_temporary_phase356_pending_signoff",
        "builds_temporary_phase357_summary",
        "runs_phase358_summary_validator",
    ):
    ...
    for field in (
        ...
        "phase359_is_not_service_resume_approval",
    ...
    for finding in _scan_forbidden_true(index):
        errors.append(f"documentops_phase354_to_phase358_validated_closure_receipt_summary_handoff_signoff_closure_index: {finding}")
    ...
    phase357_probe = _as_dict(probe_results.get("phase357_temporary_pending_summary"))
    phase358_probe = _as_dict(probe_results.get("phase358_temporary_summary_validation"))
    if phase357_probe and phase357_probe.get("readiness_status") != EXPECTED_PENDING_STATUS:
        errors.append("phase357_temporary_pending_summary.readiness_status must be pending non-approval evidence")
    if phase357_probe and phase357_probe.get("completion_ready") is not False:
        errors.append("phase357_temporary_pending_summary.completion_ready must be false")
    if phase358_probe and phase358_probe.get("completion_ready") is not False:
        errors.append("phase358_temporary_summary_validation.completion_ready must be false")
    ...
    return {
        ...
        "temporary_summary_readiness": phase357_probe.get("readiness_status", ""),
        "temporary_summary_validation_ok": phase358_probe.get("ok") is True,
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps Phase 354-358 validated handoff sign-off closure index."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = validate_documentops_phase354_to_phase358_validated_closure_receipt_summary_handoff_signoff_closure_index(
        args.index
    )
    if args.json:
