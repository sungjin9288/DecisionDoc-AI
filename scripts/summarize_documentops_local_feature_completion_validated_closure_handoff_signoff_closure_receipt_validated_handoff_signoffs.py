#!/usr/bin/env python3
"""Summarize DocumentOps validated closure receipt summary handoff sign-off records."""
...
def build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary(
    paths: Sequence[Path],
    *,
    ...
    if blocker_reasons:
        ...
        status = "all_validated_closure_receipt_summary_handoff_signoffs_accepted_no_cost_boundary_preserved"
    else:
        status = "pending_validated_closure_receipt_summary_handoff_signoff_review_no_training_authorization"
...
def _render_markdown(summary: dict[str, Any]) -> str:
    lines = [
        "# DocumentOps Validated Closure Receipt Summary Handoff Sign-Off Summary",
        "",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Summarize DocumentOps validated closure receipt summary handoff sign-off JSON records."
    )
