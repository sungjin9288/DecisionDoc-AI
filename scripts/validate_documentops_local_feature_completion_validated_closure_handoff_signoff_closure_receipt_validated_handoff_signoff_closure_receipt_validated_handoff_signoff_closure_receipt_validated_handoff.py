#!/usr/bin/env python3
"""Validate the DocumentOps Phase 82/83 validated closure summary handoff."""
...
from scripts.summarize_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipts import (  # noqa: E402
    DEFAULT_RECEIPT_PATH,
    build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary,
)
from scripts.validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary import (  # noqa: E402
    validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary,
)
...
EXPECTED_REPORT_TYPE = (
    "document_ops_phase84_local_feature_completion_validated_closure_handoff_signoff_"
    "closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_"
    "closure_receipt_validated_handoff"
)
EXPECTED_VALIDATION_REPORT_TYPE = (
    "document_ops_phase84_local_feature_completion_validated_closure_handoff_signoff_"
    "closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_"
    "closure_receipt_validated_handoff_validation"
)
EXPECTED_STATUS = (
    "local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_"
    "signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_"
    "ready_no_aws_no_training_authorization"
)
SOURCE_SUMMARY_VALIDATION_CONTRACT_PATH = (
    "docs/specs/hermes_decisiondoc_agent/"
    "phase83_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary_validation/"
    "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary_validation_contract.json"
)
SOURCE_SUMMARY_CONTRACT_PATH = (
    "docs/specs/hermes_decisiondoc_agent/"
    "phase82_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary/"
    "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary_contract.json"
)
SOURCE_SUMMARY_VALIDATOR_PATH = (
    "scripts/validate_documentops_local_feature_completion_validated_closure_handoff_signoff_"
    "closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_"
    "closure_receipt_summary.py"
)
...
REQUIRED_ACTION_IDS = {
    "generate_phase82_summary",
    "run_phase83_validator",
    "confirm_validated_local_phase82_summary",
    "confirm_no_cost_boundary",
    "preserve_service_freeze",
    "require_separate_resume_approval",
}
REQUIRED_TRUE_BOUNDARY_FIELDS = (
    "local_phase82_validated_closure_receipt_summary_handoff_recorded",
...
def _run_generated_summary_validation_probe() -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix="decisiondoc_phase84_validated_handoff_") as tmp_dir:
        summary = (
            build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary(
                [DEFAULT_RECEIPT_PATH],
        ...
        summary_path = Path(tmp_dir) / "phase84_closure_receipt_validated_handoff_summary.json"
...
def validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff(
    ...
    if handoff.get("phase") != 84:
        errors.append("phase must be 84")
    if handoff.get("status") != EXPECTED_STATUS:
        errors.append(f"status must be {EXPECTED_STATUS}")
    if handoff.get("handoff_scope") != "operator_handoff_for_validated_phase82_closure_receipt_summary":
        errors.append("handoff_scope must be operator_handoff_for_validated_phase82_closure_receipt_summary")
    ...
    if probe and probe.get("summary_ok") is not True:
        errors.append("generated Phase 82 closure receipt summary must be ok")
    if probe and validation.get("ok") is not True:
        errors.append("generated Phase 82 closure receipt summary must pass Phase 83 validation")
        for error in validation.get("errors", []):
            errors.append(f"generated_summary_validation: {error}")
    if probe and probe.get("summary_readiness_status") != (
        "all_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipts_confirm_no_cost_freeze"
    ):
        errors.append("generated summary readiness must confirm no-cost freeze")
    if probe and probe.get("receipt_count") != 1:
        errors.append("generated summary receipt_count must be 1 for the default Phase 81 receipt")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps Phase 82/83 validated closure summary handoff."
    )
    parser.add_argument(
        "handoff",
        nargs="?",
        ...
        help="Path to Phase 84 validated closure summary handoff JSON.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(
            ...
            "closure receipt validated handoff signoff closure receipt validated handoff signoff closure receipt validated handoff validated"
        )
        print(
        ...
        print(
            ...
            "closure receipt validated handoff signoff closure receipt validated handoff signoff closure receipt validated handoff validation failed"
        )
