...
from scripts.validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_index import (  # noqa: E402
...
EXPECTED_REPORT_TYPE = (
    "document_ops_phase90_local_feature_completion_validated_closure_handoff_signoff_"
...
EXPECTED_STATUS = (
    ...
    "validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_recorded_no_aws_no_training_authorization"
)
...
REQUIRED_TRUE_BOUNDARY_FIELDS = (
    ...
    "phase89_closure_index_valid",
    "phase84_to_phase88_chain_valid",
...
def validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt(
    ...
    if receipt.get("phase") != 90:
        errors.append("phase must be 90")
    ...
    for finding in _scan_forbidden_true(receipt):
        errors.append(
            "documentops_validated_closure_receipt_validated_handoff_signoff_closure_receipt_"
            f"validated_handoff_summary_handoff_signoff_closure_receipt: {finding}"
        )
    ...
    if not errors and gate_result.get("ok") is not True:
        errors.append("source_closure_gate must still pass Phase 89 closure index validation")
        ...
        for field, expected_value in expected_pairs.items():
            if source_gate.get(field) != expected_value or gate_result.get(field) != expected_value:
                errors.append(f"source_closure_gate.{field} must match current Phase 89 validation")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Path to phase90 validated handoff sign-off closure receipt JSON.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(
            ...
            " handoff signoff closure receipt validated"
        )
        ...
        print(
            ...
            "closure receipt validated handoff signoff closure receipt validated handoff signoff closure receipt validated "
            "handoff signoff closure receipt validation failed"
        )
