#!/usr/bin/env python3
"""Validate the DocumentOps Phase 117 validated handoff sign-off closure receipt."""
...
from scripts.validate_documentops_phase111_to_phase115_validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_index import (  # noqa: E402
    validate_documentops_phase111_to_phase115_validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_index,
)
...
DEFAULT_RECEIPT_PATH = (
    ...
    "phase117_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_receipt_"
    "summary_handoff_signoff_closure_receipt/"
    "validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_receipt.json"
)
EXPECTED_REPORT_TYPE = (
    "document_ops_phase117_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_"
...
EXPECTED_STATUS = (
    "validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_receipt_"
    "recorded_no_aws_no_training_authorization"
)
REQUIRED_SOURCE_HASH_PATHS = {
    "phase116_closure_index_sha256": (
        "docs/specs/hermes_decisiondoc_agent/"
        "phase116_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_receipt_"
        "summary_handoff_signoff_closure_index/"
        "validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_index.json"
    ),
    "phase116_closure_validator_sha256": (
...
REQUIRED_TRUE_BOUNDARY_FIELDS = (
    ...
    "phase116_closure_index_valid",
    "phase111_to_phase115_chain_valid",
...
EXPECTED_SOURCE_COMMAND = (
    "python3 scripts/validate_documentops_phase111_to_phase115_validated_closure_receipt_summary_handoff_signoff_"
    "closure_receipt_summary_handoff_signoff_closure_index.py"
)
...
PASS_MESSAGE = (
    "PASS documentops phase117 validated closure receipt summary handoff sign-off closure receipt summary handoff "
    "sign-off closure receipt validated"
)
FAIL_MESSAGE = (
    "FAIL documentops phase117 validated closure receipt summary handoff sign-off closure receipt summary handoff "
    "sign-off closure receipt validation failed"
)
...
def validate_documentops_phase116_validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_receipt(
    ...
    if receipt.get("phase") != 117:
        errors.append("phase must be 117")
    ...
    for finding in _scan_forbidden_true(receipt):
        errors.append(
            "documentops_phase116_validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_"
            f"handoff_signoff_closure_receipt: {finding}"
        )
    ...
    if not errors and gate_result.get("ok") is not True:
        errors.append("source_closure_gate must still pass Phase 116 closure index validation")
        ...
        for field, expected_value in expected_pairs.items():
            if source_gate.get(field) != expected_value or gate_result.get(field) != expected_value:
                errors.append(f"source_closure_gate.{field} must match current Phase 116 validation")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps Phase 117 validated handoff sign-off closure receipt."
    )
    parser.add_argument(
        "receipt",
        nargs="?",
        ...
        help="Path to Phase 117 validated handoff sign-off closure receipt JSON.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = (
        validate_documentops_phase116_validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_handoff_signoff_closure_receipt(
            args.receipt
        )
    )
    if args.json:
