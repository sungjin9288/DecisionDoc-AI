#!/usr/bin/env python3
"""Create a pending DocumentOps Phase 85 validated handoff sign-off record."""
...
def build_pending_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff(
    *,
    ...
    signoff["generation_context"] = {
        "report_type": (
            "document_ops_phase86_local_feature_completion_validated_closure_handoff_signoff_"
    ...
    signoff["next_step_after_generation"] = (
        ...
        "closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_"
        "closure_receipt_validated_handoff_signoff.py --require-complete. This sign-off "
        "records local evidence review only and does not resume service operation, AWS runtime, "
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Create a pending DocumentOps Phase 85 validated handoff sign-off JSON record."
    )
    ...
    try:
        if not args.json and args.output is not None:
            ...
            if resolved_output.exists() and not args.overwrite:
                raise FileExistsError(f"output already exists: {resolved_output}")
        signoff = build_pending_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff(
