#!/usr/bin/env python3
"""Summarize DocumentOps Phase 184 validated handoff sign-off records."""
...
REPORT_TYPE = "document_ops_phase186_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_summary"
PENDING_STATUS = "pending_phase183_validated_closure_receipt_summary_handoff_signoff_review_no_training_authorization"
ACCEPTED_STATUS = "all_phase183_validated_closure_receipt_summary_handoff_signoffs_accepted_no_cost_boundary_preserved"
FORBIDDEN_TRUE_KEYS = (
...
def summarize_signoff(path: Path, payload: dict[str, Any], *, require_complete: bool) -> dict[str, Any]:
    validation = validate_documentops_phase183_validated_closure_receipt_summary_handoff_signoff(
        payload,
...
def build_documentops_phase184_validated_closure_receipt_summary_handoff_signoff_summary(
    paths: Sequence[Path],
    *,
...
def _render_markdown(summary: dict[str, Any]) -> str:
    lines = [
        "# DocumentOps Phase 184 Validated Closure Receipt Summary Handoff Sign-Off Summary",
        "",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Summarize DocumentOps Phase 184 validated handoff sign-off JSON records."
    )
