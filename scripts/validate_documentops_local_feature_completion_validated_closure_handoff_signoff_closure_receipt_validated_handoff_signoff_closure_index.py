#!/usr/bin/env python3
"""Validate the DocumentOps validated closure receipt summary handoff sign-off closure index."""
...
from scripts.create_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_pending_signoff import (  # noqa: E402
    build_pending_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff,
)
from scripts.summarize_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoffs import (  # noqa: E402
    build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary,
)
from scripts.validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff import (  # noqa: E402
    validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff,
)
from scripts.validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff import (  # noqa: E402
    validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff,
)
from scripts.validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary import (  # noqa: E402
    validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary,
)
...
EXPECTED_REPORT_TYPE = (
    "document_ops_phase71_local_feature_completion_validated_closure_handoff_signoff_"
...
EXPECTED_ARTIFACTS = {
    "phase66_validated_closure_receipt_summary_handoff": {
        "phase": 66,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
    ...
    "phase67_validated_closure_receipt_summary_handoff_signoff_template": {
        "phase": 67,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
    ...
    "phase68_pending_validated_closure_receipt_summary_handoff_signoff_generation_contract": {
        "phase": 68,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase68_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_pending_signoff/"
            "pending_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_generation_contract.json"
        ),
        "validator": (
    ...
    "phase69_validated_closure_receipt_summary_handoff_signoff_summary_contract": {
        "phase": 69,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase69_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary/"
            "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary_contract.json"
        ),
        "validator": (
    ...
    "phase70_validated_closure_receipt_summary_handoff_signoff_summary_validation_contract": {
        "phase": 70,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase70_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary_validation/"
            "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary_validation_contract.json"
        ),
        "validator": (
            "scripts/validate_documentops_local_feature_completion_validated_closure_handoff_signoff_"
...
def _run_closure_probe() -> dict[str, Any]:
    phase66_result = validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff()
    template_path = _repo_path(
        EXPECTED_ARTIFACTS["phase67_validated_closure_receipt_summary_handoff_signoff_template"]["path"]
    )
    phase67_template_result = (
        validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff(
            _load_json(template_path)
        )
    )

    with tempfile.TemporaryDirectory(prefix="decisiondoc_phase71_closure_") as tmp_dir:
        tmp_path = Path(tmp_dir)
        pending_signoff = build_pending_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff(
            signoff_id=(
                "documentops_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_"
                "phase71probe"
            ),
            created_at="2026-05-27T00:00:00+09:00",
        )
        pending_path = tmp_path / "phase71_pending_signoff.json"
        _write_json(pending_path, pending_signoff)
        phase68_pending_result = (
            validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff(
                pending_signoff
            )
        )

        summary = build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary(
            [pending_path],
            generated_at="2026-05-27T00:00:00+09:00",
        )
        summary_path = tmp_path / "phase71_pending_summary.json"
        _write_json(summary_path, summary)
        phase70_summary_result = (
            validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_summary(
                summary_path
            )
        )
    ...
    return {
        "phase66_validated_closure_receipt_summary_handoff": phase66_result,
        "phase67_signoff_template": phase67_template_result,
        "phase68_temporary_pending_signoff": phase68_pending_result,
        "phase69_temporary_pending_summary": {
        ...
        "phase70_temporary_summary_validation": phase70_summary_result,
    }


def validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_index(
    ...
    if index.get("phase") != 71:
        errors.append("phase must be 71")
    if index.get("status") != EXPECTED_STATUS:
        errors.append(f"status must be {EXPECTED_STATUS}")
    if index.get("closure_scope") != "local_read_only_phase66_to_phase70_signoff_closure_validation":
        errors.append("closure_scope must be local_read_only_phase66_to_phase70_signoff_closure_validation")
    ...
    for field in (
        ...
        "runs_phase66_validator",
        "validates_phase67_template",
        "generates_temporary_phase68_pending_signoff",
        "builds_temporary_phase69_summary",
        "runs_phase70_summary_validator",
    ):
    ...
    for field in (
        ...
        "phase71_is_not_service_resume_approval",
    ...
    for finding in _scan_forbidden_true(index):
        errors.append(f"documentops_validated_closure_receipt_summary_handoff_signoff_closure_index: {finding}")
    ...
    phase69_probe = _as_dict(probe_results.get("phase69_temporary_pending_summary"))
    phase70_probe = _as_dict(probe_results.get("phase70_temporary_summary_validation"))
    expected_pending_status = "pending_validated_closure_receipt_summary_handoff_signoff_review_no_training_authorization"
    if phase69_probe and phase69_probe.get("readiness_status") != expected_pending_status:
        errors.append("phase69_temporary_pending_summary.readiness_status must be pending non-approval evidence")
    if phase69_probe and phase69_probe.get("completion_ready") is not False:
        errors.append("phase69_temporary_pending_summary.completion_ready must be false")
    if phase70_probe and phase70_probe.get("completion_ready") is not False:
        errors.append("phase70_temporary_summary_validation.completion_ready must be false")
    ...
    return {
        ...
        "temporary_summary_readiness": phase69_probe.get("readiness_status", ""),
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps validated closure receipt summary handoff sign-off closure index."
    )
    parser.add_argument(
        "index",
        nargs="?",
        ...
        help="Path to phase71 validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_index.json.",
    )
