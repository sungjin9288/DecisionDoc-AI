#!/usr/bin/env python3
"""Validate the DocumentOps Phase 91/92 validated closure summary handoff."""
...
EXPECTED_REPORT_TYPE = (
    "document_ops_phase93_local_feature_completion_validated_closure_handoff_signoff_"
...
READY_STATUS = (
    ...
    "closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_"
    "closure_receipts_confirm_no_cost_freeze"
)
HANDOFF_VALID_KEY = (
    "validated_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_"
    "summary_handoff_valid"
)
SOURCE_SUMMARY_VALIDATION_CONTRACT_PATH = (
    "docs/specs/hermes_decisiondoc_agent/"
    "phase92_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary_validation/"
    "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary_validation_contract.json"
)
SOURCE_SUMMARY_CONTRACT_PATH = (
    "docs/specs/hermes_decisiondoc_agent/"
    "phase91_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary/"
    "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary_contract.json"
)
SOURCE_SUMMARY_VALIDATOR_PATH = "scripts/validate_documentops_phase91_validated_closure_receipt_summary.py"
...
REQUIRED_ACTION_IDS = {
    "generate_phase91_summary",
    "run_phase92_validator",
    "confirm_validated_local_phase91_summary",
    "confirm_no_cost_boundary",
    "preserve_service_freeze",
    "require_separate_resume_approval",
}
REQUIRED_TRUE_BOUNDARY_FIELDS = (
    "local_phase91_validated_closure_receipt_summary_handoff_recorded",
...
def validate_documentops_phase92_validated_closure_receipt_summary_handoff(
    ...
    if handoff.get("phase") != 93:
        errors.append("phase must be 93")
    if handoff.get("status") != EXPECTED_STATUS:
        errors.append(f"status must be {EXPECTED_STATUS}")
    if handoff.get("handoff_scope") != "operator_handoff_for_validated_phase91_closure_receipt_summary":
        errors.append("handoff_scope must be operator_handoff_for_validated_phase91_closure_receipt_summary")
    ...
    for finding in _scan_forbidden_true(handoff):
        errors.append(f"documentops_phase92_validated_closure_receipt_summary_handoff: {finding}")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps Phase 91/92 validated closure summary handoff."
    )
    parser.add_argument(
        "handoff",
        nargs="?",
        ...
        help="Path to Phase 93 validated closure summary handoff JSON.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = validate_documentops_phase92_validated_closure_receipt_summary_handoff(args.handoff)
    if args.json:
