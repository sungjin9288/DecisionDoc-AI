#!/usr/bin/env python3
"""Validate the DocumentOps Phase 102-106 validated handoff sign-off closure index."""
...
from scripts.create_documentops_phase103_validated_closure_receipt_summary_handoff_pending_signoff import (  # noqa: E402
    build_pending_documentops_phase103_validated_closure_receipt_summary_handoff_signoff,
)
from scripts.summarize_documentops_phase103_validated_closure_receipt_summary_handoff_signoffs import (  # noqa: E402
    build_documentops_phase103_validated_closure_receipt_summary_handoff_signoff_summary,
)
from scripts.validate_documentops_phase101_validated_closure_receipt_summary_handoff import (  # noqa: E402
    validate_documentops_phase101_validated_closure_receipt_summary_handoff,
)
from scripts.validate_documentops_phase102_validated_closure_receipt_summary_handoff_signoff import (  # noqa: E402
    validate_documentops_phase102_validated_closure_receipt_summary_handoff_signoff,
)
from scripts.validate_documentops_phase105_validated_closure_receipt_summary_handoff_signoff_summary import (  # noqa: E402
    validate_documentops_phase105_validated_closure_receipt_summary_handoff_signoff_summary,
)
...
DEFAULT_INDEX_PATH = (
    ...
    "phase107_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_index/"
    "validated_closure_receipt_summary_handoff_signoff_closure_index.json"
)
EXPECTED_REPORT_TYPE = (
    "document_ops_phase107_local_feature_completion_validated_closure_receipt_summary_handoff_"
    "signoff_closure_index"
)
EXPECTED_VALIDATION_REPORT_TYPE = (
    "document_ops_phase107_local_feature_completion_validated_closure_receipt_summary_handoff_"
    "signoff_closure_index_validation"
)
EXPECTED_STATUS = (
    "validated_closure_receipt_summary_handoff_signoff_closure_index_ready_no_aws_no_training_authorization"
)
EXPECTED_SCOPE = "local_read_only_phase102_to_phase106_validated_closure_receipt_summary_handoff_signoff_closure_validation"
EXPECTED_ARTIFACTS = {
    "phase102_validated_closure_receipt_summary_handoff": {
        "phase": 102,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
        ...
        "validator": "scripts/validate_documentops_phase101_validated_closure_receipt_summary_handoff.py",
    },
    "phase103_validated_closure_receipt_summary_handoff_signoff_template": {
        "phase": 103,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase103_local_feature_completion_validated_closure_receipt_summary_handoff_signoff/"
    ...
    "phase104_pending_validated_closure_receipt_summary_handoff_signoff_generation_contract": {
        "phase": 104,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase104_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_pending_signoff/"
            "pending_validated_closure_receipt_summary_handoff_signoff_generation_contract.json"
        ),
        "validator": "scripts/create_documentops_phase103_validated_closure_receipt_summary_handoff_pending_signoff.py",
    },
    "phase105_validated_closure_receipt_summary_handoff_signoff_summary_contract": {
        "phase": 105,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase105_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_summary/"
            "validated_closure_receipt_summary_handoff_signoff_summary_contract.json"
        ),
        "validator": "scripts/summarize_documentops_phase103_validated_closure_receipt_summary_handoff_signoffs.py",
    },
    "phase106_validated_closure_receipt_summary_handoff_signoff_summary_validation_contract": {
        "phase": 106,
        "path": (
            "docs/specs/hermes_decisiondoc_agent/"
            "phase106_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_summary_validation/"
...
EXPECTED_PENDING_STATUS = "pending_phase102_validated_closure_receipt_summary_handoff_signoff_review_no_training_authorization"
...
def _run_closure_probe() -> dict[str, Any]:
    phase102_result = validate_documentops_phase101_validated_closure_receipt_summary_handoff()
    template_path = _repo_path(
        EXPECTED_ARTIFACTS["phase103_validated_closure_receipt_summary_handoff_signoff_template"]["path"]
    )
    phase103_template_result = validate_documentops_phase102_validated_closure_receipt_summary_handoff_signoff(
        _load_json(template_path)
    )

    with tempfile.TemporaryDirectory(prefix="decisiondoc_phase107_closure_") as tmp_dir:
        tmp_path = Path(tmp_dir)
        pending_signoff = build_pending_documentops_phase103_validated_closure_receipt_summary_handoff_signoff(
            signoff_id=(
                "documentops_local_feature_completion_phase102_validated_closure_receipt_summary_"
                "handoff_signoff_phase107probe"
            ),
            created_at="2026-06-02T00:00:00+09:00",
        )
        pending_path = tmp_path / "phase107_pending_signoff.json"
        _write_json(pending_path, pending_signoff)
        phase104_pending_result = validate_documentops_phase102_validated_closure_receipt_summary_handoff_signoff(
            pending_signoff
        )

        summary = build_documentops_phase103_validated_closure_receipt_summary_handoff_signoff_summary(
            [pending_path],
            generated_at="2026-06-02T00:00:00+09:00",
        )
        summary_path = tmp_path / "phase107_pending_summary.json"
        _write_json(summary_path, summary)
        phase106_summary_result = validate_documentops_phase105_validated_closure_receipt_summary_handoff_signoff_summary(
            summary_path
        )

    return {
        "phase102_validated_closure_receipt_summary_handoff": phase102_result,
        "phase103_signoff_template": phase103_template_result,
        "phase104_temporary_pending_signoff": phase104_pending_result,
        "phase105_temporary_pending_summary": {
        ...
        "phase106_temporary_summary_validation": phase106_summary_result,
    }


def validate_documentops_phase102_to_phase106_validated_closure_receipt_summary_handoff_signoff_closure_index(
    ...
    if index.get("phase") != 107:
        errors.append("phase must be 107")
    ...
    if closure_validator.get("path") != (
        "scripts/validate_documentops_phase102_to_phase106_validated_closure_receipt_summary_handoff_"
        "signoff_closure_index.py"
    ):
        errors.append("closure_validator.path must reference this validator")
    for field in (
        "checks_source_artifact_hashes",
        "runs_phase102_validator",
        "validates_phase103_template",
        "generates_temporary_phase104_pending_signoff",
        "builds_temporary_phase105_summary",
        "runs_phase106_summary_validator",
    ):
    ...
    for field in (
        ...
        "phase107_is_not_service_resume_approval",
    ...
    for finding in _scan_forbidden_true(index):
        errors.append(f"documentops_phase102_to_phase106_validated_closure_receipt_summary_handoff_signoff_closure_index: {finding}")
    ...
    phase105_probe = _as_dict(probe_results.get("phase105_temporary_pending_summary"))
    phase106_probe = _as_dict(probe_results.get("phase106_temporary_summary_validation"))
    if phase105_probe and phase105_probe.get("readiness_status") != EXPECTED_PENDING_STATUS:
        errors.append("phase105_temporary_pending_summary.readiness_status must be pending non-approval evidence")
    if phase105_probe and phase105_probe.get("completion_ready") is not False:
        errors.append("phase105_temporary_pending_summary.completion_ready must be false")
    if phase106_probe and phase106_probe.get("completion_ready") is not False:
        errors.append("phase106_temporary_summary_validation.completion_ready must be false")
    ...
    return {
        ...
        "temporary_summary_readiness": phase105_probe.get("readiness_status", ""),
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps Phase 102-106 validated handoff sign-off closure index."
    )
    parser.add_argument(
        "index",
        nargs="?",
        ...
        help="Path to Phase 107 closure index JSON.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = validate_documentops_phase102_to_phase106_validated_closure_receipt_summary_handoff_signoff_closure_index(
        args.index
    )
    if args.json:
        print(json.dumps(result, ensure_ascii=False, indent=2, sort_keys=True))
    elif result["ok"]:
        print("PASS documentops phase107 validated closure receipt summary handoff sign-off closure index validated")
        ...
        print("FAIL documentops phase107 validated closure receipt summary handoff sign-off closure index validation failed")
