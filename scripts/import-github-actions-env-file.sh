...
copy_value "${DEPLOY_SECRET_PREFIX}_HOST" "${DEPLOY_SECRET_PREFIX}_HOST"
copy_value "${DEPLOY_SECRET_PREFIX}_USER" "${DEPLOY_SECRET_PREFIX}_USER"
copy_value "${DEPLOY_SECRET_PREFIX}_SSH_KEY" "${DEPLOY_SECRET_PREFIX}_SSH_KEY"
