#!/usr/bin/env python3
"""Validate the DocumentOps Phase 109/110 validated closure receipt summary handoff."""
...
EXPECTED_REPORT_TYPE = (
    "document_ops_phase111_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_"
...
EXPECTED_STATUS = (
    ...
    "handoff_ready_no_aws_no_training_authorization"
)
READY_STATUS = "all_phase108_validated_closure_receipts_confirm_no_cost_freeze"
HANDOFF_VALID_KEY = "phase109_validated_closure_receipt_summary_handoff_valid"
SOURCE_SUMMARY_VALIDATION_CONTRACT_PATH = (
    "docs/specs/hermes_decisiondoc_agent/"
    "phase110_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_receipt_"
    "summary_validation/"
...
SOURCE_SUMMARY_CONTRACT_PATH = (
    "docs/specs/hermes_decisiondoc_agent/"
    "phase109_local_feature_completion_validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary/"
    "validated_closure_receipt_summary_handoff_signoff_closure_receipt_summary_contract.json"
)
SOURCE_SUMMARY_VALIDATOR_PATH = (
    "scripts/validate_documentops_phase109_validated_closure_receipt_summary_handoff_signoff_"
    "closure_receipt_summary.py"
)
SOURCE_SUMMARY_REPORTER_PATH = "scripts/summarize_documentops_phase108_validated_closure_receipts.py"
REQUIRED_RECIPIENTS = {
    "release_owner",
    "operator",
    "product_pm_reviewer",
...
REQUIRED_ACTION_IDS = {
    "generate_phase109_summary",
    "run_phase110_validator",
    "confirm_validated_local_phase109_summary",
    "confirm_no_cost_boundary",
    "preserve_service_freeze",
    "require_separate_resume_approval",
}
REQUIRED_TRUE_BOUNDARY_FIELDS = (
    "local_phase109_validated_closure_receipt_summary_handoff_recorded",
...
PASS_MESSAGE = "PASS documentops phase111 validated closure receipt summary handoff validated"
FAIL_MESSAGE = "FAIL documentops phase111 validated closure receipt summary handoff validation failed"
...
def validate_documentops_phase110_validated_closure_receipt_summary_handoff(
    ...
    if handoff.get("phase") != 111:
        errors.append("phase must be 111")
    if handoff.get("status") != EXPECTED_STATUS:
        errors.append(f"status must be {EXPECTED_STATUS}")
    if handoff.get("handoff_scope") != "operator_handoff_for_validated_phase109_closure_receipt_summary":
        errors.append("handoff_scope must be operator_handoff_for_validated_phase109_closure_receipt_summary")
    ...
    for finding in _scan_forbidden_true(handoff):
        errors.append(f"documentops_phase110_validated_closure_receipt_summary_handoff: {finding}")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the DocumentOps Phase 109/110 validated closure receipt summary handoff."
    )
    parser.add_argument(
        "handoff",
        nargs="?",
        ...
        help="Path to Phase 111 validated closure receipt summary handoff JSON.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = validate_documentops_phase110_validated_closure_receipt_summary_handoff(args.handoff)
    if args.json:
