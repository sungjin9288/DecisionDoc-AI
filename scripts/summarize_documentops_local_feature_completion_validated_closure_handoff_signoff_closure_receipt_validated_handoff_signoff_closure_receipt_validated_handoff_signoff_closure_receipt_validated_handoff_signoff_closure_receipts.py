#!/usr/bin/env python3
"""Summarize DocumentOps Phase 90 validated closure receipt records."""
...
from scripts.validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt import (  # noqa: E402
    validate_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt,
)
...
EXPECTED_SCHEMA = (
    ...
    "closure_receipt_validated_handoff_signoff_closure_receipt_summary.v1"
)
DEFAULT_RECEIPT_PATH = (
    REPO_ROOT
    / "docs/specs/hermes_decisiondoc_agent/"
    "phase90_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt/"
    "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt.json"
)
FORBIDDEN_TRUE_KEYS = (
...
def summarize_receipt(path: Path, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "phase89_closure_index_sha256": source_hashes.get("phase89_closure_index_sha256", ""),
        "phase89_closure_validator_sha256": source_hashes.get("phase89_closure_validator_sha256", ""),
...
def build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary(
    paths: Sequence[Path],
    *,
    ...
    if load_errors:
        blocker_reasons.append(
            "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_load_errors"
        )
    if not receipts:
        blocker_reasons.append(
            "no_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipts"
        )
    if invalid_count:
        blocker_reasons.append(
            "invalid_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipts"
        )
    if boundary_break_count:
        blocker_reasons.append(
            "validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_boundary_breaks"
        )

    status = (
        "all_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipts_confirm_no_cost_freeze"
    ...
    return {
        "report_type": (
            "document_ops_phase91_local_feature_completion_validated_closure_handoff_signoff_"
            "closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_"
            "closure_receipt_validated_handoff_signoff_closure_receipt_summary"
        ),
        "phase": 91,
        ...
        "side_effect_boundary": {
            "reads_local_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipts": True,
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Summarize DocumentOps Phase 90 validated closure receipt JSON records."
        )
    )
    parser.add_argument(
        "receipts",
        ...
        help="Closure receipt JSON file(s) or directories. Defaults to the Phase 90 receipt.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    summary = (
        build_documentops_local_feature_completion_validated_closure_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_validated_handoff_signoff_closure_receipt_summary(
            args.receipts,
