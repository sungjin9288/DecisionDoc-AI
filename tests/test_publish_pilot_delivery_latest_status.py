...
from scripts.publish_pilot_delivery_latest_status import publish_pilot_delivery_latest_status
...
def test_publish_pilot_delivery_latest_status_writes_stable_file(tmp_path):
    ...
    assert latest["receipt_matches"] is True
