...
from scripts.publish_pilot_delivery_latest_overview import (
    publish_pilot_delivery_latest_overview,
)
...
def test_publish_pilot_delivery_latest_overview_writes_markdown(tmp_path):
    ...
    assert "pilot_delivery_status: **PASS**" in content
