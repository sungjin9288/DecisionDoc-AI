...
from scripts.publish_pilot_delivery_latest_readiness_note import (
    publish_pilot_delivery_latest_readiness_note,
)
...
def test_publish_pilot_delivery_latest_readiness_note_writes_markdown(tmp_path):
    ...
    assert "ready: **PASS**" in content
    assert "latest_status_file:" in content
    assert "latest_audit_file:" in content
