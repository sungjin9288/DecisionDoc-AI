...
from scripts.publish_pilot_delivery_latest_readiness import publish_pilot_delivery_latest_readiness
...
def test_publish_pilot_delivery_latest_readiness_writes_stable_json(tmp_path):
