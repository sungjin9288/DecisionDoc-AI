...
def _write_fixture_repo(repo: Path, bundler) -> None:
    ...
    readiness = {
        ...
        "source": {
            ...
            "source_describe": "v1.1.65-fixture",
            "source_exact_tag": "",
            "expected_release_tag": "v1.1.65",
...
def test_create_company_handoff_bundle_copies_artifacts_and_writes_manifest(tmp_path: Path) -> None:
    ...
    assert manifest["release_tag"] == "v1.1.65"
    assert manifest["source"]["source_describe"] == "v1.1.65-fixture"
    ...
    assert "Source describe: `v1.1.65-fixture`" in (bundle_dir / "README.md").read_text(encoding="utf-8")
