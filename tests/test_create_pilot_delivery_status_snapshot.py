...
from scripts.create_pilot_delivery_status_snapshot import create_pilot_delivery_status_snapshot
...
def test_create_pilot_delivery_status_snapshot_writes_json(tmp_path):
    ...
    assert saved["receipt_matches"] is True
