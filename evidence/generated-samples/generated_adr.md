# ADR: Portfolio Evidence Demo

## Goal
Validate implemented document generation with mock provider.

## Context
Evidence collection run for portfolio review. No private data is included.
