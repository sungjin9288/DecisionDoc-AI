...
AUDIT_RULES: dict[tuple[str, str], str] = {
    ...
    (
        "GET",
        "/projects/{id}/guided-decision-review-handoff",
    ): "procurement.guided_review_handoff_download",
    (
        "POST",
        "/projects/{id}/guided-decision-review-handoff/recheck",
    ): "procurement.guided_review_handoff_recheck",
    (
        "POST",
        "/projects/{id}/guided-decision-review-handoff/review-disposition",
    ): "procurement.guided_review_disposition",
    ("POST", "/projects/{id}/guided-decision-review-dispositions"): "procurement.guided_review_registry_create",
    ("GET", "/projects/{id}/guided-decision-review-dispositions"): "procurement.guided_review_registry_list",
    ("GET", "/projects/{id}/guided-decision-review-dispositions/{id}"): "procurement.guided_review_registry_read",
    ("GET", "/projects/{id}/guided-decision-review-dispositions/{id}/download"): "procurement.guided_review_registry_download",
