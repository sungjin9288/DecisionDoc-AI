...
ACTION_TYPES: dict[str, str] = {
    ...
    "generated_document_review.prepare": "생성 문서 검토 전달 준비",
    "generated_document_review.inbox_view": "생성 문서 검토함 조회",
    "generated_document_review.project_history_view": "생성 문서 검토 전달 이력 조회",
    "generated_document_review.packet_download": "생성 문서 검토 패킷 다운로드",
    ...
    # DocumentOps
    "document_ops.agent_run": "DocumentOps Agent 실행",
